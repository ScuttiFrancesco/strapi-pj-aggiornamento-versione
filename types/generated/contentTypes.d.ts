...
export interface ApiComunicatiStampaComunicatiStampa
  ...
  attributes: {
    ...
    altro_editor: Schema.Attribute.RichText &
      ...
      >;
    coloreTitolo: Schema.Attribute.String &
    ...
    comunicati_stampa: Schema.Attribute.Relation<
      'oneToOne',
      'api::comunicati-stampa.comunicati-stampa'
    >;
    configuratore: Schema.Attribute.Relation<
      'oneToOne',
      'api::configuratore.configuratore'
    >;
    ...
    > &
      Schema.Attribute.Private;
    new_editor: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'defaultHtml';
...
export interface ApiConfiguratoreConfiguratore
  extends Struct.CollectionTypeSchema {
  collectionName: 'configuratores';
  info: {
    displayName: 'Configuratore';
    pluralName: 'configuratores';
    singularName: 'configuratore';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    testo: Schema.Attribute.Component<'layout.solo-testo', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHeaderBarHeaderBar extends Struct.SingleTypeSchema {
  collectionName: 'header_bars';
  info: {
    displayName: 'Header-Bar';
    pluralName: 'header-bars';
    singularName: 'header-bar';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dynamic: Schema.Attribute.DynamicZone<['config.data-config']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::header-bar.header-bar'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOfficeOffice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    _softDeletedById: Schema.Attribute.Integer & Schema.Attribute.Private;
    _softDeletedByType: Schema.Attribute.String & Schema.Attribute.Private;
    copertina: Schema.Attribute.Media<'images' | 'files'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    new: Schema.Attribute.Blocks;
    pagina: Schema.Attribute.DynamicZone<
      ['postazioni.postazione1', 'postazioni.postazione2']
    > &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::configuratore.configuratore': ApiConfiguratoreConfiguratore;
      'api::footer.footer': ApiFooterFooter;
      'api::header-bar.header-bar': ApiHeaderBarHeaderBar;
